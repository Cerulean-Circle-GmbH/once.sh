...
- `docs/research/` - Reviews and forensics, e.g. the [T7 config/branch-variable research](research/2026-09-16-t7-config-branch-variables.md), [T8 PATH-ownership research](research/2026-09-16-t8-path-ownership.md) (delivered — the rule it argues for is now [boot.md § The PATH-writer rule](boot.md), enforced by `path validate`) and the [boot-loader review](research/review-2026-09-09-boot-loader-pure-env-files.md)
