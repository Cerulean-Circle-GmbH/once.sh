...
- `docs/research/` - Reviews and forensics, e.g. the [T7 config/branch-variable research](research/2026-09-16-t7-config-branch-variables.md) and the [boot-loader review](research/review-2026-09-09-boot-loader-pure-env-files.md)
